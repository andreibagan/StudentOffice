...
namespace StudentOffice.Controllers
{
    public class DocumentController : Controller
    {
        ...
        public async Task<IActionResult> ApplicationOfApplicant(string id)
        {
            ...
            User user = await _userManager.Users.Include(i => i.Anketa).ThenInclude(i => i.DocumentType).Include(i => i.Anketa).ThenInclude(i => i.Specialty).ThenInclude(i => i.Groups).FirstOrDefaultAsync(i => i.UserName == id);
        ...
        public async Task<IActionResult> DormitoryApplication(string id)
        {
            ...
            //    return File(client.DownloadData(location), file_type, file_name);
            //}
            User user = await _userManager.Users.Include(i => i.Anketa).ThenInclude(i => i.Specialty).ThenInclude(i => i.Groups).FirstOrDefaultAsync(i => i.UserName == id);
