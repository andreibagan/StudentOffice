...
namespace StudentOffice.Controllers
{
    public class DocumentTypeController : Controller
    {
        ...
        public DocumentTypeController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DocumentTypeId,Name")] DocumentType documentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DocumentTypeId,Name")] DocumentType documentType)
        {
